...
public class StudentSignupActivity extends AppCompatActivity {
    ...
    private EditText editAddress, editSchool, editGrade; // ✅ 학년 추가
    ...
    private void initViews() {
        ...
        editGrade = findViewById(R.id.edit_grade); // ✅ XML에 있는 학년 입력 필드
    ...
    private void setupListeners() {
        ...
        btnSignup.setOnClickListener(v -> {
            ...
            String gradeStr = editGrade.getText().toString().trim(); // ✅ 사용자 입력 학년
            ...
            if (idStr.isEmpty() || pwStr.isEmpty() || pwConfirmStr.isEmpty() ||
                    ...
                    address.isEmpty() || school.isEmpty() || gradeStr.isEmpty()) {
            ...
            try {
                ...
                Toast.makeText(this, "학년은 숫자로 입력해주세요.", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            Log.d("회원가입 요청", "주소=" + address + ", 학교=" + school + ", 학년=" + grade);
